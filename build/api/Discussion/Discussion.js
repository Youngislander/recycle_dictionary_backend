...
var _default = {
  Discussion: {
    files: function files(_ref) {
      var id = _ref.id;
      return _prismaClient.prisma.discussion({
        id: id
      }).files();
    },
    ...
    isLiked: function () {
      var _isLiked = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(parent, _, _ref5) {
        var request, user, id;
